...
description: "Build a Spring Boot API that scans uploaded files with ClamAV to detect malware before persisting content."
date: 2025-04-28
tags: [cybersecurity, spring-boot, api]
draft: false
readingTime: 14 min
...
![Prix de VirusTotal](/blog-media/wrapper-clamav-antivirus-api/image.png)
