...
description: "Learn how to self-host an LLM with Ollama, expose it through an API, secure access, and integrate it into a Spring Boot application."
date: 2025-06-09
tags: [api, llm]
draft: false
readingTime: 8 min
...
![image.png](/blog-media/heberger-son-llm-accessible-via-api/image.png)
